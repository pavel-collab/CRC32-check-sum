...
static char *path_to_directory = NULL; ///< path to the target directory; Daemon looks after this dir
...
int main(int argc, char* argv[]) {
    ...
    */
    ...
    if (errno = pthread_create(&inotify_thread, NULL, threadInotifyRun, new_daemon)) {
    ...
    if (errno = pthread_create(&daemon_thread, NULL, threadDaemonRun, new_daemon)) {
        perror("pthread_create");
        return -1;
    }
