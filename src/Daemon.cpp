...
void Daemon::startMainLoop() {
    ...
    // firstly generate initial event, it trigges Daemon to save crc32 check sums for all of files in target dir
...
DaemonDestroyer::~DaemonDestroyer() {   
    delete daemon_instance; 
}